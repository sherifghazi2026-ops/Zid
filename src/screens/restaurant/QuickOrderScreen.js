// src/screens/restaurant/QuickOrderScreen.js
...
export default function QuickOrderScreen({ navigation }) {
  ...
  // هنا هنستخدم ملف PDF لكن مؤقتاً هنعرض أصناف افتراضية
  // في التطبيق الفعلي، هتحتاج API لقراءة PDF أو قاعدة بيانات للأصناف
  const loadMenuFromPDF = (restaurant) => {
    setSelectedRestaurant(restaurant);
    // مؤقت: أصناف افتراضية حسب نوع المطعم
    let items = [];
