      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.voiceSection}>
          ...
          {!recordedUri ? (
            ...
            >
              <Ionicons name={isRecording ? "stop" : "mic"} size={24} color={isRecording ? "#FFF" : "#F59E0B"} />
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row-reverse', alignItems: 'center', padding: 20, paddingTop: 50, backgroundColor: '#FFF', borderBottomLeftRadius: 25, borderBottomRightRadius: 25, elevation: 3 },
  ...
  itemCard: { width: (width - 45) / 2, backgroundColor: '#FFF', borderRadius: 20, padding: 15, alignItems: 'center', marginBottom: 15, borderWidth: 1, borderColor: '#F3F4F6', elevation: 2 },
  ...
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: '#FFF', padding: 20, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: '#E5E7EB', paddingBottom: 35 },
